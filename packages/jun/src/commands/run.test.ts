...
describe("junRunLogic", () => {
  ...
  it("should run a simple command to completion", async () => {
    const exitCode = await junRunLogic({command: "echo", commandArgs: ["hello"], background: false, json: false, output: "raw"});
  ...
  it("should run a foreground command with --json output", async () => {
    ...
    await junRunLogic({command: "echo", commandArgs: ["hello"], background: false, json: true, output: "raw"});
  ...
  it("should strip ansi codes when output is 'text'", async () => {
    ...
    await junRunLogic({command, commandArgs, background: false, json: false, output: "text"});
