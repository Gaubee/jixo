...
import {X, Info, AlertTriangle, CheckCircle, Terminal} from "lucide-react";
  ...
  return (
    <div className="absolute bottom-2 right-2 z-50 w-80 space-y-2">
      {notifications.map((notification) => {
        ...
        return (
          <div key={notification.id} className={cn("animate-in slide-in-from-bottom-4 flex items-start rounded-lg p-3 shadow-lg", typeStyles[notification.type])}>
